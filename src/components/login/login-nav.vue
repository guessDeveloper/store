<template>
  <div class="login-nav">
    <div class="box">
      ...
      <span class="type" v-if="type == 'login'">
         登录
      </span>
      ...
      <router-link class="home" tag="a" to="/login" v-if="type=='register'">已有账户，<span>立即登录</span></router-link>
  ...
  background:#fff;
   .box{
     ...
     .type{
       ...
       border-left:2px solid @class_border;
     }
     .home{
       float: right;
       font-size:16px;

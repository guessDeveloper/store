    ...
    <div class="reset-box">
      ...
      <div class="tab-item" :class="{active:step == 1}">
        ...
        <div class="input-line-box">
          <label for="">用户名称：</label> <input type="text" placeholder="手机号码" v-model.trim="userNmae">
        </div>
        <div class="input-line-box">
      ...
      <div class="tab-item" :class="{active:step == 2}">
        ...
        <div class="input-line-box">
          ...
          <div class="input-box"><input type="text" placeholder="输入短信验证码" v-model.trim="msgCode"><span class="getCode" @click="getCode">{{codeBtn}}</span></div>
        </div>
        <div class="input-line-box">

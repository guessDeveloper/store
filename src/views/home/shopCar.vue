      ...
      <div class="car-list">
        <div class="item" v-for="(goodItem,goodIndex) in item.goodsList" :key="goodIndex">
          ...
          <div class="content">
            ...
            <div class="price-box">单价：<i>{{goodItem.GoodsMoneny}}</i> <span class="score">预估积分：<i>{{parseInt(goodItem.num*goodItem.Goodsfanli)}}</i></span></div>

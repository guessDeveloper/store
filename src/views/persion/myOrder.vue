  ...
  <div class="myOrder-box">
    ...
    <div class="order-content" v-show="tab == '1'" v-loading="loading">
      <div class="choose-small-box">
        ...
        <div class="date-box">
          <div class="small-date-box">
            <el-date-picker v-model="onlieTime[0]" type="date" :editable="false" :clearable="false" value-format="yyyy-MM-dd" placeholder="开始日期" @change="getOnlineList">
            </el-date-picker>
          </div>
          <div class="date-middle"> -</div>
          <div class="small-date-box">
            <el-date-picker v-model="onlieTime[1]" @change="getOnlineList" type="date" :editable="false" :clearable="false" value-format="yyyy-MM-dd" placeholder="结束日期">
            </el-date-picker>
          </div>
        </div>
      ...
      <div class="choose-box">
        <div class="date-box">
          <el-date-picker v-model="onlieTime" :editable="false" :clearable="false" type="daterange" range-separator="-" value-format="yyyy-MM-dd" start-placeholder="开始日期" @change="getOnlineList" end-placeholder="结束日期">
          </el-date-picker>
        </div>
      ...
      <div class="table-box">
        <el-table :data="listData" header-row-style="font-size:12px;color:#999;" row-class-name="table-line" width="930" class="table-big">
          ...
          <el-table-column property="OrderNumber" label="订单号" width="200" align="center"></el-table-column>
          <el-table-column property="Name" label="产品名称" width="138" align="left"></el-table-column>
          <el-table-column property="CreateTime" label="消费日期" width="125" align="center"></el-table-column>
      ...
      <div class="page-box">
        <el-pagination @current-change="getOnlineList" :current-page.sync="pageIndex" :page-size="pageSize" layout="prev, pager, next, jumper" :total="onlineTotal">
        </el-pagination>
      </div>
      <div class="page-box small">
        <el-pagination small v-show="onlineTotal!=0" @current-change="getOnlineList" :current-page.sync="pageIndex" :page-size="pageSize" layout="prev, pager, next" :total="onlineTotal">
        </el-pagination>
      </div>
    </div>
    <!-- 线上订单 end -->
    ...
    <div class="order-content" v-show="tab=='2'" v-loading="underlineLoading">
      <div class="choose-small-box choose-small-box-2">
        <div class="date-box">
          <div class="small-date-box">
            <el-date-picker v-model="unlineTime[0]" type="date" :editable="false" :clearable="false" @change="getUnderLineList" value-format="yyyy-MM-dd" placeholder="开始日期">
            </el-date-picker>
          </div>
          <div class="date-middle"> -</div>
          <div class="small-date-box">
            <el-date-picker v-model="unlineTime[1]" type="date" :editable="false" :clearable="false" @change="getUnderLineList" value-format="yyyy-MM-dd" placeholder="结束日期">
            </el-date-picker>
          </div>
        </div>
        <div class="select-box">
          <div class="status-wrap">
            ...
            <el-select v-model="unlineOrderType" placeholder="请选择" class="select" @change="getUnderLineList">
              <el-option v-for="item in unlineType" :key="item.value" :label="item.label" :value="item.value">
              </el-option>
            </el-select>
          </div>
        </div>
      ...
      <div class="choose-box">
        <div class="date-box">
          <el-date-picker v-model="unlineTime" type="daterange" value-format="yyyy-MM-dd" range-separator="-" start-placeholder="开始日期" end-placeholder="结束日期" @change="getUnderLineList" default-time="">
          </el-date-picker>
        </div>
        <div class="status-select">
          状态
      ...
      <div class="table-box">
        ...
        <div class="page-box">
          <el-pagination v-show="unlineTotal!=0" @current-change="getUnderLineList" :current-page.sync="unlineIndex" :page-size="unlineSize" layout="prev, pager, next, jumper" :total="unlineTotal">
          </el-pagination>
        </div>
        <div class="page-box small">
          <el-pagination small v-show="unlineTotal!=0" @current-change="getUnderLineList" :current-page.sync="unlineIndex" :page-size="unlineSize" layout="prev, pager, next" :total="unlineTotal">
          </el-pagination>
        </div>
        <!-- 评价 -->
        <el-dialog title="评价" :visible.sync="toRate" custom-class="custom-dialog">
          <div class="rate-box">
            <div class="input-line">
              ...
              <div class="input-box" style="padding-top:7px;">
            ...
            <div class="input-line" style="margin-top:10px;">
              ...
              <div class="input-box">
                <div class="textarea-box"><textarea name="" id="" cols="30" rows="10" placeholder="宝贝是否满足了你的期待？说说你的使用心得分享给其它想购买的朋友吧" v-model="comment" maxlength="500"></textarea><span class="input-limit">还可输入{{500-comment.length}}字</span></div>
              </div>
            </div>
            <div class="btn-box">

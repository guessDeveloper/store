  ...
  <div :class="['store-page', {'store-page-center': enterpriseSet}]">
    ...
    <div class="content">
      <div class="input-line link">
        ...
        <div class="input-box"><input type="text" :value="infos.Invitelink" readonly class="readonly"><button class="copy" :data-clipboard-text="infos.Invitelink">复制</button></div>
      </div>
      ...
      <div class="input-line">
        ...
        <div class="input-box">
          <el-upload class="upload-demo" :action="uploadImgUrl()" :on-preview="handlePreview" :on-remove="logoRemove" :on-success="logoSuccess" accept=".jpg,.png,.jpeg" :file-list="fileList" :beforeUpload="beforeLogoUpload" name="FileContent" list-type="picture">
      ...
      <div class="input-line">
        <label for="">商家介绍：</label>
        <div class="input-box">
          <el-upload class="upload-demo" :action="changeUrl" :on-success="mp4Success" :on-remove="handleRemove" :on-change="uploadChane" :data="sendData" :on-preview="handlePictureCardPreview" name="FileContent" accept=".jpg,.png,.mp4,.jpeg,.gif" :beforeUpload="beforeBannerUpload" multiple :file-list="desMp4" ref="mp4Uploader" :auto-upload="false">
            <button size="small" type="primary" class="upload-btn">选择上传文件</button>
      ...
      <div class="input-line">
        ...
        <div class="input-box" style="height:50px;margin-top:20px;" v-show="value!==''">
          <el-select v-model="secondOptionValue" placeholder="请选择" @change="setCat">
            <el-option v-for="item in secondOption" :key="item.Id" :label="item.CategoryName" :value="item.Id">
            </el-option>
          </el-select>
...
export default {
  ...
  methods: {
    ...
    uploadChane(file) {
      ...
      setTimeout(() => {
        console.log(this.$refs.mp4Uploader.uploadFiles, '8883')
